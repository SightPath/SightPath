...
urlpatterns = [
    ...
    # 找比賽
    path("competition_info/<str:pk>", views.info, name="competition_info"),
    path("activity_info/<str:pk>", views.info, name="activity_info"),
    path("find_competition/", views.findpage, name="find_competition"),
    path("find_activity/", views.findpage, name="find_activity"),
