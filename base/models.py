...
class OurTag(models.Model):
    ...
    emb = models.JSONField(default=list)
    emb_org = models.JSONField(default=list)
...
class Competition(models.Model):
    ...
    description = models.TextField(null=True)  # guide_line_html
...
class Room(models.Model):
    ...
    likes = models.ManyToManyField(
        User, default=0, related_name="likes"
    )
